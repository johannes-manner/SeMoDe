...
public final class AzurePerformanceDataUtility extends CustomUtility {
	...
	public void start(List<String> args) {
		...
		String fileName = functionName + (System.currentTimeMillis() % 1000) + ".csv";

		new AzureLogHandler(accountName, accountKey, shareName, functionName).writePerformanceDataToFile(fileName);
	}
}
